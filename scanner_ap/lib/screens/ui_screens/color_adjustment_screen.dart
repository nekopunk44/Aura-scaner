...
class _ColorAdjustmentScreenState extends State<ColorAdjustmentScreen> {
  ...
  ({double value, double min, double max, int divisions, String unit}) _activeParamSpec() {
    switch (_activeParam) {
      case _Param.brightness:
        return (value: _brightness, min: 0.5, max: 2.0, divisions: 30, unit: '');
      case _Param.contrast:
        return (value: _contrast, min: 0.5, max: 2.0, divisions: 30, unit: '');
      case _Param.saturation:
        return (value: _saturation, min: 0.0, max: 2.0, divisions: 40, unit: '');
      case _Param.hue:
                        ...
                        child: Row(
                          children: [
                            _ParamChip(
                              ...
                              textColor: textColor,
                              subColor: subColor,
                              onTap: () => setState(() => _activeParam = _Param.brightness),
                            ),
                            ...
                            _ParamChip(
                              ...
                              textColor: textColor,
                              subColor: subColor,
                              onTap: () => setState(() => _activeParam = _Param.contrast),
                            ),
                            const SizedBox(width: 8),
                            _ParamChip(
                              ...
                              textColor: textColor,
                              subColor: subColor,
                              onTap: () => setState(() => _activeParam = _Param.saturation),
                            ),
                            const SizedBox(width: 8),
                            _ParamChip(
                              label: l10n.colorHue,
                              ...
                              textColor: textColor,
                              subColor: subColor,
                              onTap: () => setState(() => _activeParam = _Param.hue),
                            ),
                          ],
                        ),
                      ),
